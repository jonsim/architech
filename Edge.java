...
class Edge {
   ...
   Edge(Vertex v1, Vertex v2, CoordStore coordStore) {
      ...
      this.v1 = coordStore.addVertex(v1.x, v1.y, v1.z, this);
      this.v2 = coordStore.addVertex(v2.x, v2.y, v2.z, this);
   }
   ...
   public Line2D.Float topDownView() {
      return new Line2D.Float(v1.x, v1.y, v2.x, v2.y);
   }
   ...
   public String toString() {
      ...
      return "v1:(" + v1.x + ", " + v1.y + ", " + v1.z + ") v2:(" + v2.x + ", " + v2.y + ", " + v2.z + ")";
   }
}